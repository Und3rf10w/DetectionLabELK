...
If (-not ($service)) {
  ...
  Invoke-WebRequest -UseBasicParsing -Uri "https://raw.githubusercontent.com/palantir/osquery-configuration/master/Classic/Endpoints/Windows/osquery.flags" -OutFile $flagfile
